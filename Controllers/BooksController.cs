...
namespace LibraryManagementApp.MVC.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BookTitle,SeriesName,Author,OriginallyPublished,Genres")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookTitle,SeriesName,Author,OriginallyPublished,Genres")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
